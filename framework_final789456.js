...
}//driver initialization for browserstack
...
driver
    ...
    .then(async function abc() {
        for (var i = 0; i < mydata.Sheet1.length; i++) {//for iterating upto the number of steps
            ...
            switch (keyword) {
                case "input"://for input feature
                    ...
                    switch (type) {//determining type of the step
                        case "textbox": console.log("running for " + type + " type input");
                            ...
                            }//calling print function for displaying desired values
                ...
                case "verify":
                    ...
                    switch (type) {
                        ...
                        default: printstep = ((i + 1));
                            printmsg = ("---error occured : type Error .at step:" + (i + 1));
                            status = "fail";
                            print(printstep, status, printmsg);
                    }//calling print function for displaying desired values                
                    break;
